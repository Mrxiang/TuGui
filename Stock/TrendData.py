...
class TrendData():
    ...
    def get_trend_data(self):
        ...
        daily = self.pro.daily_basic(trade_date=today)
        print( daily )
        ...
        result_df=pd.merge( result_df, self.stock_basic, on='ts_code', how='left')
        result_df = result_df.loc[result_df['density'] == 0]
        return  result_df
...
if __name__ == '__main__':
    ...
    result.to_csv(today+"_trend_data.csv")
