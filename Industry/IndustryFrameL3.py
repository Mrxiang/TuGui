...
from Industry.IndustryDataL3 import IndustryDataL3
import matplotlib
...
class IndustryFrameL3(Frame): #自己创建的这个类就是一个组件，这个要继承Frame类
    ...
    def query_industry_spot(self ):
        df_spot =IndustryDataL3().get_index_spot()
    ...
    def query_index_cons(self, code):
        df_cons =IndustryDataL3().get_index_cons(code)
    ...
    def query_index_daily(self, code):
        ...
        df = IndustryDataL3().get_index_daily(code)
        print( df.head(10) )
...
if __name__ == '__main__':
    ...
    industry_frame = IndustryFrameL3( root )
